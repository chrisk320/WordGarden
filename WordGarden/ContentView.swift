...
//  WordGarden
//
//  Created by Christian Kim on 2/9/25.
//
...
struct ContentView: View {
    private static let maximumGuesses = 8  // Need to refer to this as Self.maximumGuess
    ...
    func updateGamePlay() {
        ...
        if !revealedWord.contains("_") {
            gameStatusMessage = "You Guesssed It! It Took You \(lettersGuessed.count) Guesses to Guess the Word"
            wordsGuessed += 1
            currentWordIndex += 1
